...
<html lang="en">
  ...
  <body class="flex items-center h-screen"
        style=" background-image: linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.6)), url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvcQXupf4jiwkw-mCtJkoBPmki8cIu9BTnAyXoLin6gW7drJpjHSEVlE0&s=10');
    ...
    <div class="min-h-screen flex items-center justify-center w-full dark:bg-gray-950">
      <div class="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 max-w-md">
        <div class="login-logo">
                <img src="https://www.dbl.id/uploads/school/17487/521-SMA_KARTIKA_1-5.png" alt="Logo" height="100" width="100" justify-content="center" class="mx-auto mb-2">
            </div>
